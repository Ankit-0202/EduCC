...
const std::vector<IRInstruction>& IntermediateRepresentation::getInstructions() const {
    return instructions;
}

// Provide mutable access to instructions
std::vector<IRInstruction>& IntermediateRepresentation::getMutableInstructions() {
    return instructions;
}
